        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
            <div className="rounded-2xl border border-border/80 bg-card/60 p-4 text-center backdrop-blur-md">
              ...
              <p className="text-xl sm:text-2xl font-black text-foreground">Urban Power</p>
            ...
            <div className="rounded-2xl border border-border/80 bg-card/60 p-4 text-center backdrop-blur-md">
              ...
              <p className="text-xl sm:text-2xl font-black text-foreground">RankRise USA</p>
            ...
            <div className="rounded-2xl border border-border/80 bg-card/60 p-4 text-center backdrop-blur-md">
              ...
              <p className="text-xl sm:text-2xl font-black text-foreground">DigiQlik & Overseas</p>
            ...
            <div className="rounded-2xl border border-border/80 bg-card/60 p-4 text-center backdrop-blur-md">
              ...
              <p className="text-xl sm:text-2xl font-black text-foreground">TechForex</p>
