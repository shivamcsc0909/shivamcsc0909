      ...
      <section className="relative w-full py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-primary/10 via-background to-background border-b border-border/50">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto">
            <div className="rounded-3xl border border-border/80 bg-card/75 p-6 backdrop-blur-xl shadow-lg space-y-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-primary/15 text-primary">
                <Code2 className="h-5 w-5" />
              </div>
              <h3 className="font-extrabold text-foreground text-base">Frontend & 3D WebGL</h3>
              ...
              <div className="pt-2 flex flex-wrap gap-1">
                {['Next.js', 'Three.js', 'GSAP', 'TypeScript'].map((t) => (
                  <span key={t} className="rounded bg-muted/60 px-2 py-0.5 text-[10px] font-medium text-foreground">
                    {t}
                  </span>
                ))}
              </div>
            ...
            <div className="rounded-3xl border border-border/80 bg-card/75 p-6 backdrop-blur-xl shadow-lg space-y-3">
              ...
              <h3 className="font-extrabold text-foreground text-base">Backend & Real-Time</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <div className="rounded-3xl border border-border/80 bg-card/75 p-6 backdrop-blur-xl shadow-lg space-y-3">
              ...
              <h3 className="font-extrabold text-foreground text-base">Mobile App Engineering</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <div className="rounded-3xl border border-border/80 bg-card/75 p-6 backdrop-blur-xl shadow-lg space-y-3">
              ...
              <h3 className="font-extrabold text-foreground text-base">Cloud, DB & DevOps</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
