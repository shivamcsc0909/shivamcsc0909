...
छवि दिखाएं
MERN + JWT	JWT-authenticated task management with user roles	Source
छवि दिखाएं
MERN + Stripe	Full-featured online store with payment integration	Demo
छवि दिखाएं
MERN + Socket.IO	WebSocket-powered messaging platform	Demo
छवि दिखाएं
MERN + OpenAI	Intelligent chatbot with sentiment analysis	Demo
छवि दिखाएं
MERN + RBAC	Multi-role job platform with admin panel	Demo
छवि दिखाएं
WordPress + Elementor	Professional business showcase website	Live
</div>
📘 Education
<div align="center">
